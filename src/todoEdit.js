...
const TodoEdit = ({ navigation,route }) => {
  ...
  const updateTodoFunc = (index,todo,hasDeadline, deadTime, deadDate) => {
    ...
    {
      setTodo('');
      dispatch(updateTodo(index,todo,hasDeadline,deadline));
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          updateTodoFunc(route.params.index,todo,hasDeadline,deadTime,deadDate)
        }}>
        <Text style={{ fontSize: 22, color: 'rgb(177,116,222)',fontFamily:'ZenDots-Regular' }}>Update</Text>
      </TouchableOpacity>
      <TouchableOpacity
